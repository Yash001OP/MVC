...
<head>
    ...
    <title>Edit Product - Laravel MVC</title>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('product_description') is-invalid @enderror" 
                                              ...
                                              required
                                              oninput="updateCharCount(this)">{{ old('product_description', $product->product_description) }}</textarea>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card bg-light">
                                    <div class="card-body">
                                        <h6 class="card-title">
                                            <i class="fas fa-info-circle me-1"></i>Product Info
                                        </h6>
                                        <ul class="card-text small mb-0">
                                            <li><strong>ID:</strong> #{{ $product->id }}</li>
                                            <li><strong>Created:</strong> {{ $product->created_at->format('M j, Y') }}</li>
                                            <li><strong>Updated:</strong> {{ $product->updated_at->format('M j, Y') }}</li>
                                            @if($product->category)
